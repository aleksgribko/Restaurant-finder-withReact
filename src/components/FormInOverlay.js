...
class FormInOverlay extends Component{
	...
	return (
		<div>
			<button style={{height:"50px", width:'100%', marginTop:"10px"}} onClick={() => $('form').slideToggle(500)}>Leave a review</button>
			<form style={{display: 'none', fontSize: '1rem', width: '100%', paddingTop: '10px'}}>
				<label>
				...
				<textarea name="newReview" onChange={this.handleChangeReview}></textarea><br />
				<button style={{height:"50px", width:'100%', marginTop:"10px"}} onClick={this.receiveReview}>Submit</button>				
			</form>			
		</div>
	)
	}
