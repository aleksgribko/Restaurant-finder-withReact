...
class MapGoogle extends Component {
  ...
  showError(error) {
   switch(error.code) {
     ...
     alert("User denied the request for Geolocation. To use this site properly you need to allow geolocation requests")
     break;
...
loadTheMap(){
 if (this.state.center !== null) {return(
  <GoogleMapReact
      bootstrapURLKeys={{ key: 'AIzaSyDCJD8ghgxEJJdmUIr9_m0mY_wBEUOW5Dw', 
      libraries: 'places',}}          
